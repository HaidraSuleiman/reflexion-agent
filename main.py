...
def draft_node(state: MessagesState):
    ...
    return {"messages": [response]} #again it will get appended to the state automatically not replaced
...
res = graph.invoke(
    {
        "messages": [
            {
                "role": "user",
                "content": "Wrte about AI-Powered SOC / autonomous soc problem domain, list startups that do that and raised capital"
            }
        ]
    }
)
